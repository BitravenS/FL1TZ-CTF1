...
class Square:
    ...
    def display(self):
        ...
        max_content_width = max(
            len(self.title), *(len(opt) for opt in numbered_options)
        )
        ...
        for i, option in enumerate(self.options, 1):
            ...
            option_lines.append(
                f"{Fore.GREEN}║{padded_option}{Fore.GREEN}║{Style.RESET_ALL}"
            )
...
class character:
    def __init__(
        self, name, armament_haki=0, observation_haki=0, conqueror_haki=0, stars=0
    ):
        self.name = name
...
def imu(char):
    ...
    if choice == 2:
        ...
        if (
            ...
            and char.observation_haki == 1
            and char.conqueror_haki == 1
            and char.stars == 5
            and char.glasses == 1
        ):
            printt(
                "You are the strongest , you defeat IMU and you are now the king of the island"
            )
            sleep(2)
...
def blackhole(char):
    ...
    if choice == 2:
        ...
        if choice == 2:
            ...
            sleep(1)
            printt(
                "And suddenly a THIEF (with a dog) who gets close to you  and says :"
            )
            sleep(1)
            printt(
                "Hey you look weak , i am bitraven the thief and this is my dog 'musashi-grabs' , do you like algebra ??"
            )
            sleep(2.5)
            ...
            if choice == 1:
                ...
                sleep(2)
                printt(
                    "SIKEEEE YOU REALLY LIKE ALGEBRA ????????  THE THIEF ROBBED YOU !!! (what did he take tho)"
                )
                sleep(2)
                ...
                sleep(2)
                printt(
                    "That was a tough journey , you are now stronger , the strongest you have ever been"
                )
                sleep(3)
                ...
                if choice == 1:
                    printt(
                        "While chilling you blinked and you got teleported to a dark room"
                    )
                    sleep(2)
                    printt("A magician approaches you and says : ")
                    sleep(2)
                    printt(
                        "Can you decode this for me ? and i'll teleport you to the last boss !"
                    )
                    sleep(2)
                    ...
                    if choice == 2:
                        printt(
                            "Decoding is for other challenges not this one , get out !"
                        )
                        sleep(2)
                        exit()
                    else:
                        printt(
                            "You told him : You are a magician you should do it yourself !"
                        )
                        sleep(2)
                        printt(
                            "He actually remembers that he is a magician and thanks you for that ! he decodes his key and teleport you !!!!!!!"
                        )
                        sleep(4)
                        imu(char)
    elif choice == 3:
...
def spiritual_twin(char):
    ...
    if choice == 1:
        if char.observation_haki == 0:
            printt(
                "You are weaker than your spiritual twin in all aspects , you can't kill him"
            )
            sleep(2)
        ...
        printt(
            "Why are you scared , you are fighting your spiritual twin not a monster(ALGEBRA)"
        )
        sleep(2)
...
def island(char, arg):
    if arg == 0:
        ...
        sleep(1)
        printt(
            "You look around you see a tight hole through two giant rocks and a path to the left which has human feet traces :O "
        )
        sleep(5)
    ...
    if choice == 3:
        ...
        sleep(2)
        printt(
            "You are feeling lazy, STOP CHILLING AND GET UP !!! , am kidding you can sleep "
        )
        sleep(2)
